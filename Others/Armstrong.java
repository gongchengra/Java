...
/**
 * A utility to check if a given number is armstrong or not. Armstrong number is a number that is
 * equal to the sum of cubes of its digits for example 0, 1, 153, 370, 371, 407 etc. For example 153
 * = 1^3 + 5^3 +3^3
 *
...
public class Armstrong {
  ...
  /**
   * Checks whether a given number is an armstrong number or not. Armstrong number is a number that
