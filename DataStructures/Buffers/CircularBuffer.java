...
public class CircularBuffer {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    for (char c : "abcdefghijklmnopqrstuvwxyz0123456789".toCharArray()) {
      cb.writeToCharBuffer(c);
      //        System.out.println(cb.writeToCharBuffer(c));
      i++;
      if (i % buffer_size == 0) {
        for (int j = 0; j < buffer_size; j++) {
          //                System.out.println(i);
          //                System.out.println(j);
          System.out.println(cb.readOutChar());
        }
      }
    }
    //    cb.writeToCharBuffer('a');
    //    cb.writeToCharBuffer('b');
    //    cb.writeToCharBuffer('c');
    //    cb.writeToCharBuffer('d');
    //    System.out.println(cb.readOutChar());
    //    System.out.println(cb.readOutChar());
    //    System.out.println(cb.readOutChar());
    //    System.out.println(cb.readOutChar());
